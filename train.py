...
if __name__ == '__main__':
    ...
    train_dataset = ImageDataset(config_dict['train_path'], config_dict['device'], config_dict['train_crop_size'])
    train_loader = DataLoader(dataset=train_dataset, batch_size=config_dict['train_batch_size'], shuffle=True)
    test_dataset = ImageDataset(config_dict['validate_path'], config_dict['device'], config_dict['validate_crop_size'])
    test_loader = DataLoader(dataset=test_dataset, batch_size=config_dict['validate_batch_size'], shuffle=False)
